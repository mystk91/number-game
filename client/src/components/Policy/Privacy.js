...
function Privacy(props) {
  return (
    <div className="privacy policy">
      ...
      <p>
        Your privacy is important to us, and we want you to
      ...
      <p>
        ...
        sign in using your Google, Facebook, Apple, or Twitter accounts. We use
        this to manage your account, keep track of purchases, and to communicate
        with you about updates and offers. Additionally, we use cookies to
        create login sessions and to keep track of games.
      </p>
      ...
      <h3>Security</h3>
      <p>
        We follow industry standard practices to protect your account information. While we do our best to protect your data, no method of
